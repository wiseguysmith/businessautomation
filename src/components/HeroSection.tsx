    ...
    <section className="relative isolate flex min-h-[86svh] items-center overflow-hidden bg-ink text-cream">
      ...
      <div className="page-shell py-20 sm:py-28">
        <div className="max-w-2xl">
          <p className="eyebrow">AI Business Transformation Assessment</p>
          <h1 className="mt-5 text-6xl font-black leading-[0.93] tracking-tight sm:text-8xl">
            Build your<br />AI workforce<br />in minutes.
          </h1>
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-stone-300 sm:text-lg sm:leading-8">
            See how an AI team — intake specialist, sales assistant, inbox manager —
            handles your leads, drafts responses, and keeps you in control, all in
            seconds. Built for local businesses ready to stop losing opportunities.
          </p>
